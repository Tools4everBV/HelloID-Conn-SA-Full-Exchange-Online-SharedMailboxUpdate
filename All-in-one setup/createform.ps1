...
<# Begin: DataSource "exchange-online-shared-mailbox-update | EntraID-Check-DisplayName-Unique" #>
$tmpPsScript = @'
# variables configured in form
$mailbox = $datasource.selectedMailbox
...
exchange-online-shared-mailbox-update | EntraID-Check-DisplayName-Unique
'@ 
...
<# End: DataSource "exchange-online-shared-mailbox-update | EntraID-Check-DisplayName-Unique" #>
